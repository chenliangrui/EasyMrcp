...
/**
 * 共享调度版 TTS RTP 处理器。
 * 保留当前主链路的 input/output 双缓冲、processOnce()、interrupt() 和共享调度语义。
 */
@Slf4j
public class NettyTtsRtpProcessor {
    ...
    public NettyTtsRtpProcessor(String remoteIp, int remotePort, int mediaType, int frameBytes, int sendIntervalMs) throws Exception {
